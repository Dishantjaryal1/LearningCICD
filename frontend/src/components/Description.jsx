    ...
    className="flex flex-col items-center justify-center my-24 p-6 md:px-28">
      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        <div>
            ...
            <p className="text-gray-600">Simply type in a text prompt, and our cutting-edge Ai will generator high-quality images in seconds. From product visuals to character designs and portraits, even concepts that dont yet exist can be visualized effortlessly. Powered by advanced AI technology, the creative possibilities are limitless!</p>
        </div>
      </div>
    </motion.div>
  )
